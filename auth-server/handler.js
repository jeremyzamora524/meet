...
const credentials = {
  ...
  redirect_uris: ["https://jeremyzamora524.github.io/meet"],
  javascript_origins: ["https://jeremyzamora524.github.io", "http://localhost:3000"]
};
...
/**
 * In the second step, we generate an access token in exchange for the code obtained in getAuthURL
 */
...
/**
 * In a third step, we use the obtained access token to get a list of events from the Google Calendar API
 */
...
module.exports.getCalendarEvents = async (event) => {
  ...
  // Set the obtaines access_token as part of the credentials of the oAuth2Client
